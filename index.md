...
4. Cohen-Kappa score as the evaluation metric <br>
...
Made use of:
1. Web scraping - Scrape song lyrics
2. Spotify API -Gather audio features
3. NRC emotion lexicon -calculate song emotion scores
4. Cosine similarity - calculate similarity scores
5. Streamlit - test out the recommendations <br>
...
####  Predicting the outcome of a game of chess
 
 [![](https://img.shields.io/badge/colab-Run%20colab%20notebook-orange)](link-to-our-project) 
 
Used supervised machine learning algorithms (Logistic Regression,Desicion Trees and Random Forest) to predict the outcome of a game.
...
#### Drug use 
<img src="images/Screenshot (58).png" width="400"/>

#### Fatal Police shootings 
<img src="images/Screenshot (56).png" width="400"/>

#### Green House gas emmissions 
<img src="images/Screenshot (60).png" width="400"/>
